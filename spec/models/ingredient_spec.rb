  ...
  describe "relationships" do
   ...
   describe "class methods" do
    before :each do
      ...
      @dish_3 = @chef_1.dishes.create!(name: 'Rotisserie Chicken', description: 'Roatisery Chicken')
      @dish_4 = @chef_2.dishes.create!(name: 'Chicken Saltamiboca', description: 'Chicken in a Lemon sauce with Pasta')
      @dish_5 = @chef_2.dishes.create!(name: 'Lemon Italian Ice', description: 'Cup of Lemon Italian Ice')
      ...
      @dish_4.ingredients << @chicken
      @dish_4.ingredients << @pasta
      @dish_4.ingredients << @lemon
      @dish_4.ingredients << @white_wine

      @dish_5.ingredients << @lemon
    end
 
    it "#favorite_ingredient" do
      expect(Ingredient.favorite_ingredient(@chef_1)).to eq(@chicken)
      expect(Ingredient.favorite_ingredient(@chef_2)).to eq(@lemon)
    end
  end
end